...
export default function AdminPanel() {
  ...
  // Common departments - you can modify this list
  const departments = [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="mt-2 text-gray-600">Manage teachers, cabin numbers, and departments</p>
          </div>
          <button
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>Changes made here will be reflected immediately in the Teacher Finder app.</p>
                  </div>
                </div>
              </div>
            </div>
